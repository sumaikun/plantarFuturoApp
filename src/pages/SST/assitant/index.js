...
//flux
import { getListUsers, getSSTAssistants, goToAssistantForm, getSSTVisitorAssistants } from '../../../flux/actions';
...
class AsistantList extends Component {
  ...
  render() {
    let  { listSSTAssistants, listUser } = this.props.appState,  listData = []
                  ...
                  <div>
                    ...
                    <Col width="50%">
                      <div className="center" style={styles.mainListItem}>
                        ...
                        <span style={styles.projectName}>{memo.contractor_id}</span>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getSSTVisitorAssistants:(assistant)=>{dispatch(getSSTVisitorAssistants(assistant))},
    goToAssistantForm: ()=> {dispatch(goToAssistantForm())},
    getListUser: (id)=> {dispatch(getListUsers(id))}
