...
import { createTunnelDeformation , updateTunnelDeformation } from '../../flux/actions';
//helper


const styles = formCardStyles;

class TunnelDeformation extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <AppPage  title={["Deformación de ", <strong>Tunel</strong>]} backButton={true} backButtonCallBack={()=>{ }}>
...
export default  connect(mapStateToProps, { createTunnelDeformation , updateTunnelDeformation })(TunnelDeformation);
