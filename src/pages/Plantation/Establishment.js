      ...
      <div style={{backgroundColor:"#e6e7e8",height:"100%"}}>
        ...
        <form className="simpleForm"  onSubmit={this.submitData}>
          ...
          <Row>
            ...
            <Col width="59%">
              <Card style={styles.cardInput}>
                <Input style={styles.textInput} type="number" name="people" value={this.state.formData.people} onChange={this.handleChangeInput} placeholder="No. personas en campo" disabled={this.state.isDisable} required />
              </Card>
            </Col>
