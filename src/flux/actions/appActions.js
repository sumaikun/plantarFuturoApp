...
export const setEstablishmentDefaultActivities = (data) => ({
  type: SET_ESTABLISHMENT_DEFAULT_ACTIVITIES,
  payload: data,
});

export const setMaintenanceDefaultActivities = (data) => ({
  type: SET_MAINTENANCE_DEFAULT_ACTIVITIES,
  payload: data,
});
