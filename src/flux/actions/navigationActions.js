import { GO_TO_LOGIN, GO_TO_MANAGEMENT, GO_TO_PROJECTS, GO_TO_FORESTAL_UNITS, GO_BACK, GO_TO_FORM_INVENTORY,
   ...
   GO_TO_CIVIL_MANAGEMENT,GO_TO_SST_LIST, GO_TO_SST_FORM, GO_TO_ASSISTANT_LIST,GO_TO_VISITANT_LIST, GO_TO_FUEL_FORM, GO_TO_ASSISTANT_FORM, 
   GO_TO_PLANTATION,
...
export const goToVisitantList = () =>({
  type: GO_TO_VISITANT_LIST
})
