...
class Modal extends Component {
  ...
  componentDidMount(){
    // Get DOM Elements
    const modal = document.querySelector('#my-modal-Assistant');
    const modalBtn = document.querySelector('#modal-btn-Assistant');
    const modalMultiple = document.querySelectorAll('.modal-btn-Assistant');
  ...
  render() {
    ...
    return (
      <div id="my-modal-Assistant" class="modal" style={this.props.ModalStyles.view}>
        <div class="modal-content" style={this.props.ModalStyles.content}>
          ...
          <div class="modal-body" style={this.props.ModalStyles.body}>
            {/* <button id="modal-btn-Assistant" className="button">Click Here</button*/}
            {this.props.children}
          </div>
